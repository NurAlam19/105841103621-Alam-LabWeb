...
class imageSlider extends Component {
  render() {
    const images = [
      require('./assets/produk1.png'),
      require('./assets/produk2.png'),
      require('./assets/produk1.png'), // Repeated image as example
      require('./assets/produk2.png'), // Repeated image as example
    ];
